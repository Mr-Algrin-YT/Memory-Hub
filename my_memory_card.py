...
questions_list.append(
    Question('Что в майнкрафте делает команда: /gamemode 1?','Включает творческий режим','Сохраняет мир','Создаёт сервер','Перезапускает игру'))
questions_list.append(
    Question('Что означает SCP?', 'Secure Contain Protect', 'Ничего', 'СЦП', 'Мир'))
questions_list.append(
    Question('Что в майнкрафте делает команда: /tick freeze?', 'Останавливает время', 'Выдаёт вам командный блок', 'Удаляет мир', 'Делает вас оператором'))
questions_list.append(
    Question('99?', '99', '606', '666', '000'))
questions_list.append(
    Question('Что такое РБМК?', 'Реактор Большой Мощности Канальный', 'Ничего', 'КМБР', '???'))
questions_list.append(
    Question('Что такое Zirnox?', 'Самый простой реактор', 'Ничего', 'Самый сложный реактор', 'Стандартный реактор'))
